...
#ifndef __LAPLACIAN_KERNEL_ORIGINAL_H__
#define __LAPLACIAN_KERNEL_ORIGINAL_H__
...
class LaplacianKernelOriginal : public GraphKernel
{
...
public:
  ...
  LaplacianKernelOriginal (const LaplacianKernelOriginal* clone);
   ...
   */
  LaplacianKernelOriginal (GraphEditDistance* edit, const Dataset & trainset, const Dataset & testset, double sigma = 1.0, int regularization=0, double lambda=1.0);
  ...
  LaplacianKernelOriginal (GraphEditDistance* edit, const Dataset & trainset, double sigma = 1.0, int regularization=0, double lambda=1.0);
  ...
  LaplacianKernelOriginal (GraphEditDistance* edit, double sigma = 1.0, int regularization=0, double lambda=1.0)
...
#endif // __LAPLACIAN_KERNEL_ORIGINAL_H__
