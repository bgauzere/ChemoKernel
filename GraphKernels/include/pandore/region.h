...
public:
    ...
    */
   Reg1d& operator=(const Ulong val);
...
public :
    ...
    */
   ValueType* operator[]( Long row ) { return (ValueType*)Imx2d<Long>::operator[](0)[row]; }
    ...
    * @return	the vector at the specified row.
    */
   const ValueType* operator[]( Long row ) const { return (ValueType*)Imx2d<Long>::operator[](0)[row]; }
    ...
    * @return	the region map itself.
    */
   Reg2d& operator=(const Ulong val);
...
public:
    ...
    * @return	the region map itself.
    */
   Reg3d& operator=( const Ulong val );
    ...
    */
   ValueType** operator[]( Long dep ) { return (ValueType**)Imx3d<Long>::operator[](0)[dep]; }
    ...
    * @return	the plane at the specified depth.
    */
   const ValueType*const* operator[]( Long dep ) const { return (ValueType**)Imx3d<Long>::operator[](0)[dep]; }
